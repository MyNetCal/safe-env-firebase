  ...
  <div>
    <table class="w-full">
      ...
      <my-table-rows
        ...
        :index="index"
        :dataName="dataName"
        :dataNameIndex="dataNameIndex"
        :dataNameIndexName="dataNameIndexName"
        :activeRows="activeRows"
        :deleteIcon="deleteIcon"
        @onReorder="emitNewOrder"
        @onClick="$emit('onClick', { rowInfo: row, rowIndex: index })"
        @onDeleteIcon="onDeletingIcon"
