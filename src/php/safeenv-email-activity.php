...
try {
    ...
    $mail->Body = "<p>A new activity has been logged into the SafeEnv app. The email attachment is a copy of the pdf file saved in the system.</p>" .
        "<p>You should be able to see or download the original pdf anytime from the app. Also, from the app you are able to see the photos and documents uplaoded to the server.</p>";
    $mail->clearAddresses();
